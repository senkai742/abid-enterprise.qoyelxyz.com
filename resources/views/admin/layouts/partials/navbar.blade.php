<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item"> <a class="nav-link" data-widget="pushmenu" href="{{route('admin.dashboard')}}" role="button"><i class="fas fa-bars"></i></a> </li>
      
    </ul>

    <!-- SEARCH FORM -->
   <div class="form-inline ml-3"><b>@yield('content-header')</b></div>
    <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto">
        <li class="navbar-item"> @yield("content-actions")  </li>
